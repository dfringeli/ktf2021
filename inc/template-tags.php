...
if ( ! function_exists( 'ktf2021_posted_on' ) ) :
	...
	function ktf2021_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'ktf2021' ),
...
if ( ! function_exists( 'ktf2021_posted_by' ) ) :
	...
	function ktf2021_posted_by() {
		$byline = sprintf(
			...
			esc_html_x( 'by %s', 'post author', 'ktf2021' ),
...
if ( ! function_exists( 'ktf2021_entry_footer' ) ) :
	...
	function ktf2021_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			$categories_list = get_the_category_list( esc_html__( ', ', 'ktf2021' ) );
			if ( $categories_list ) {
				/* translators: 1: list of categories. */
				printf( '<span class="cat-links">' . esc_html__( 'Posted in %1$s', 'ktf2021' ) . '</span>', $categories_list ); // WPCS: XSS OK.
			}
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'ktf2021' ),
					array(
						'span' => array(
							'class' => array(),
						),
